...
if(isset($_GET['action']) && $_GET['action']=="suppression"){
  ...
  $chemin_photo_produit_a_suprprimer = $_SERVER['DOCUMENT_ROOT']. $produit_a_supprimer['photo'];

  if(!empty($produit_a_supprimer['photo']) && file_exists($chemin_photo_produit_a_suprprimer)){
    unlink($chemin_photo_produit_a_suprprimer);
  }
...
<?php echo $content ?>
<input type="hidden" name="id_produit" value="<?php "
