      ...
      if($_POST) {
          ...
          if(!$verif_caractere || (strlen($_POST['pseudo']) < 1 || strlen($_POST['pseudo']) > 20)) {
              ...
              if($membre->rowCount() > 0) {
                  ...
                  executeRequete("INSERT INTO membre (pseudo, mdp, nom, prenom, email, civilite, ville, code_postal, adresse, accepter) 
                  VALUES ('$_POST[pseudo]',MD5('$_POST[mdp]'),'$_POST[nom]','$_POST[prenom]', '$_POST[email]','$_POST[civilite]','$_POST[ville]','$_POST[cp]','$_POST[adresse]','$_POST[accepter]')");
...
<form method="post" action="">
  ...
  <label for="">
    <input class="form-check-input" type="checkbox" name="accepter" id="gridCheck"  >J'accepte les CGU
  </label><br>
